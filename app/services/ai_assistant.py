...
_PUBLIC_REVIEW_COVERAGE_ITEMS = (
...

    {
        ...
        "timing": "August 17-28, 2026",
        "route": "/articles/south-pasadena-august-2026-guide",
        "details": (
            "Five ranked plans covering two remaining Thursday farmers-market nights, weekly singer-songwriter and "
    ...
    },
    {
        ...
        "timing": "August 17-September 6, 2026",
    ...
    },
    {
        ...
        "timing": "August 17-September 27, 2026",
...
def _public_review_live_query_response(text: str, role_context: str) -> Optional[str]:
    ...
    if wants_huntington_beach and not wants_restaurants:
        return "\n".join(
            (
                "The current PerkNation Huntington Beach guide ranks six coastal plans from August 17-29, 2026:",
    ...
    if wants_long_beach:
        return "\n".join(
            (
                "The current PerkNation Long Beach guide ranks seven late-August plans from August 17-30, 2026:",
    ...
    if wants_laguna_beach and not wants_restaurants:
        return "\n".join(
            (
                "The current PerkNation Laguna Beach guide ranks seven current late-summer arts plans from August 17-September 6, 2026:",
    ...
    if wants_santa_monica and not wants_restaurants:
        return "\n".join(
            (
                "The current PerkNation Santa Monica guide ranks six late-summer plans from August 17-September 27, 2026:",
    ...
    if wants_south_pasadena and not wants_restaurants:
        return "\n".join(
            (
                "The current PerkNation South Pasadena guide ranks five local plans from August 17-28, 2026:",
                "- Thursday farmers-market nights plus weekly singer-songwriter and musical-theater open mics.",
                "- August 17 and 21 family library activities.",
    ...
    if wants_pasadena and not wants_restaurants:
        return "\n".join(
            (
                "The current PerkNation Pasadena guide ranks six August plans from August 17-30, 2026:",
